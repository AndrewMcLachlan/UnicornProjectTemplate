...
namespace Unicorn
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Unicorn", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    [ProvideProjectItem(VsPackage.ProjectTypeGuid, "My Items", @"..\..\Templates\ProjectItems\Unicoen", 500)]
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "uproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "Unicorn";

        internal const string Language = "Unicorn";
